...
test:
	...
	python3 -m py_compile tests/mobile_selenium_test.py tests/ai_model_discovery_selenium_test.py tests/pdf_review_selenium_test.py tests/pdf_local_citation_selenium_test.py tests/real_pdf_smoke_selenium.py tests/graph_relations_selenium_test.py
	cargo test
